...
<SCRIPT>
	function selectnow() {
		...
		var zip2 = zip.substring(4, 7);//4이상 7미만사이의 두번째 우편번호
		...
		<table width="414" height="100" border="0" align="center"
			...
			<tr>
				<td bgcolor="#999999" align="center"><input type="image"
					src="./resources/images/member/ZipCode_img01.gif" width="413"
					height="58"></td>
			</tr>
			<tr>
				<td bgcolor="f5ffea" align="center"><strong><font
						color="#466d1b"><span class="style1">[거주지의 면.동을 입력하고
								'찾기'버튼을 누르세요!!!]</span></font></strong></td>
			</tr>
			<tr height="30">
				<td bgcolor="f5ffea" align="center"><input type="text"
					name="dong" size="10" maxlength="10">&nbsp;<input
					type="image" src="./resources/images/member/m-i02.gif" width="69"
					height="19" align="absmiddle" onfocus="this.blur()"></td>
			</tr>
			<%
				//if(dong != null){
			%>
