...
<body>
	<div id="mJoin_wrap">
		...
		<form name="m" method="post" action="member_join_ok"	onsubmit="return join_check();">
			<table id="mJoin_t">
				...
				<tr>
					...
					<td><input name="mem_zip" id="mem_zip" size="3"
						class="input_box" readonly />- <input name="mem_zip2"
						id="mem_zip2" size="3" class="input_box" readonly /> <%-- readonly 속성은 읽기만 가능. --%>
						<input type="button" value="우편검색" class="input_b"
						onclick="post_check();" /></td>
				</tr>
				<tr>
					<th>주소</th>
					<td><input name="mem_addr" id="mem_addr" size="40"	class="input_box" readonly /></td>
				</tr>
				<tr>
					<th>나머지 주소</th>
					<td><input name="mem_addr2" id="mem_addr2" size="36" class="input_box" /></td>
				</tr>
				<tr>
					<th>폰번호</th>
					<td><select name="mem_phone01" id="mem_phone01">
						...
						class="input_box" />-<input name="mem_phone03" id="mem_phone03"
						size="4" maxlength="4" class="input_box" /> <%-- maxlength="4"로 지정하면 최대 4자까지만 입력가능 --%>
					</td>
				</tr>
				<tr>
					<th>전자우편</th>
					<td><input name="mail_id" id="mail_id" size="14"
						class="input_box" /> @<input name="mail_domain" id="mail_domain"
						size="18" class="input_box" readonly /> <select name="mail_list"
			...
			<div id="mJoin_menu">
				<input type="submit" value="가입" class="input_b" /> <input	type="reset" value="취소" class="input_b"
