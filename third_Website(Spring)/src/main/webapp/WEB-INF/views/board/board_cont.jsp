...
<input type="button" value="삭제" onclick="location='/controller/board/board_del?bno=${b.bno}&page=${page}';"/>
<%-- get방식으로 ?bno=번호&page=쪽번호 주소창에 노출되는 get방식으로 각각 bno와 page 파라미터이름에 번호와 쪽 번호를 담아서 전달 --%>
...
<script>
//var bno=3;//게시판 번호
var bno=${b.bno};//게시판 번호, 자바스크립트에서 jsp 문법인 jstl or el을 사용 가능하다.
